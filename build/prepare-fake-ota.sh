...
ROOTFS_URL=${ROOTFS_URL:-'http://localhost/ut/upload/10.08.2022/ubuntu-touch-android9-arm64.tar.gz'}
#ROOTFS_URL=${ROOTFS_URL:-'http://localhost/ut/upload/A9Plus/ubuntu-touch-android9-arm64.tar.gz'}
#ROOTFS_URL=${ROOTFS_URL:-'https://ci.ubports.com/job/xenial-hybris-android9-android11-rootfs-arm64/lastSuccessfulBuild/artifact/ubuntu-touch-android9-arm64.tar.gz'}
...
case "$deviceinfo_bootimg_os_version" in
    ...
    11)
        ...
        DEVICE_GENERIC_URL='http://localhost/ut/upload/10.08.2022/halium_halium_arm64.tar.xz'
        ;;
    *)
